...
server.registerPrompt("code-review", {
    ...
    argsSchema: {
        ...
        reviewType: (0, completable_js_1.completable)(zod_1.z.enum(["security", "performance", "style", "logic"]), (value) => {
            const reviewTypes = ["security", "performance", "style", "logic"];
            return reviewTypes.filter(type => type.startsWith(value.toLowerCase()));
        }),
...
if (globalThis.process) {
    globalThis.process.on('SIGINT', gracefulShutdown);
